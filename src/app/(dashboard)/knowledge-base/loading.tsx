      ...
      <div className="rounded-3xl bg-white/90 border border-border/80 p-5 sm:p-7 shadow-blend space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5">
          <div className="flex items-center gap-3.5">
            <div className="w-12 h-12 rounded-2xl bg-muted/50 border border-border shrink-0" />
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Skeleton className="h-6 w-64 sm:w-80 rounded-xl bg-muted/70" />
                <Skeleton className="h-5 w-24 rounded-full bg-muted" />
              </div>
              <Skeleton className="h-3.5 w-72 sm:w-96 rounded-md bg-muted" />
            </div>
          </div>
